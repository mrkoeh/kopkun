...
<form action="/ubah-pendidikan/<?php echo e($getpendidikan->id); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <input type="text" class="form-control" name="nama_pendidikan" value="<?php echo e($getpendidikan->nama_pendidikan); ?>">
              </div>
            </div>
            </div>
        </div>
