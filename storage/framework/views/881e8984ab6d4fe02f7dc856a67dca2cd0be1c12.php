...
<?php if(count($res) == 0): ?>
<div class="alert alert-danger">Tidak ditemukan berdasarkan Pendidikan <b>   <?php echo e(isset($tipe_name->nama_pendidikan) ? $tipe_name->nama_pendidikan : null); ?> <b/></div>
<?php else: ?>
<div class="alert alert-success">Ditemukan berdasarkan Pendidikan <b>   <?php echo e(isset($tipe_name->nama_pendidikan) ? $tipe_name->nama_pendidikan : null); ?> <b/></div>
