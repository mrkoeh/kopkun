...
@if(count($res) == 0)
<div class="alert alert-danger">Tidak ditemukan berdasarkan Pendidikan <b>   {{ $tipe_name->nama_pendidikan or null}} <b/></div>
@else
<div class="alert alert-success">Ditemukan berdasarkan Pendidikan <b>   {{ $tipe_name->nama_pendidikan or null}} <b/></div>
