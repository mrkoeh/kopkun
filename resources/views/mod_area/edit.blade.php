...
<form action="/ubah-area/{{$getarea->id}}" method="post" enctype="multipart/form-data" class="form-horizontal">
      {{ csrf_field() }}
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <input type="text" class="form-control" name="nama_area" value="{{$getarea->nama_area}}">
              </div>
            </div>
            </div>
        </div>
